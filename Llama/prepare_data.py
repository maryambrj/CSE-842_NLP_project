...
if __name__ == '__main__':
    ...
    preprocessed_data_dir = './extracted_data'
    if not os.path.exists(preprocessed_data_dir):
        os.makedirs(preprocessed_data_dir)

    save_data_pairs(train_data_pairs, os.path.join(preprocessed_data_dir, 'train_data.json'))
    save_data_pairs(dev_data_pairs, os.path.join(preprocessed_data_dir, 'dev_data.json'))
    save_data_pairs(test_data_pairs, os.path.join(preprocessed_data_dir, 'test_data.json'))
